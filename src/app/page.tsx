...
import Seed from '../app/components/Seed'; // Seed 컴포넌트
...
export default function HomePage() {
  ...
  const [scriptures, setScriptures] = useState<BibleVerse[] | null>(null);
  ...
  const cardImages = [
    '/images/courage.jpg',
    '/images/evangelism.jpg',
    '/images/wish.jpg',
  ];

  const backImages = [
    '/images/courageBack.jpg',
    '/images/evangelismBack.jpg',
    '/images/wishBack.jpg',
  ];
